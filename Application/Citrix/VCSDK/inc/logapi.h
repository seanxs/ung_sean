...
*
*  $Id: //icaclientcore/ironcove/base/src/inc/logapi.h#2 $
*
...
#ifdef WINCE
typedef int  (PWFCAPI PLOGPRINTF)( ULONG LogClass, ULONG LogEnable, PCHAR pFormat, ... );
#else
...
#ifdef WINCE
int  WFCAPI LogPrintf( ULONG LogClass, ULONG LogEnable, PCHAR pFormat, ... );
#else
