 ...
 *
 * $Id: //icaclientcore/ironcove/base/src/inc/ctxgraph.h#2 $
 *
 *  Copyright 1999-2011 Citrix Systems, Inc. 
 *
 *****************************************************************************/
...
#ifdef WINCE
typedef UINT WINAPI mySetDIBColorTable(HDC hdc, UINT uStartIndex, UINT cEntries, CONST RGBQUAD* pColor);

#define SCRATCH_BUFFER_TYPE_SCREEN                  0
#define SCRATCH_BUFFER_TYPE_COMPATIBLE_DC           1

#define MAX_SCRATCH_BUFFERS                         3
#define MAX_SCRATCH_BUFFER_SIZE                     524288

typedef struct _SCRATCH_BUFFER_STRUCT
{
    HDC         hdc;
    BYTE        type;
    PBITMAPINFO pbi;
    ...
    HBITMAP     hbmpold;
    HINSTANCE   hCoreDLL;
    mySetDIBColorTable *pSetDIBColorTable;
    BYTE        *bits;
} SCRATCH_BUFFER_STRUCT, *PSCRATCH_BUFFER_STRUCT;
...
#ifdef WINCE
typedef PSCRATCH_BUFFER_STRUCT (_PVPAPI PFN_GETSCRATCHBUFFER)(HGDC, int, int, BYTE, int, BYTE);
typedef BOOL (_PVPAPI PFN_BLTFROMSCRATCHBUFFER)(HGDC, int, int, int, int, int, int, DWORD, PSCRATCH_BUFFER_STRUCT, BYTE *, int, int, int, int, RGBQUAD *, int, BOOL);
typedef BOOL (_PVPAPI PFN_GLYPHBLTFROMSCRATCHBUFFER)(HGDC, int, int, int, int, int, int, DWORD, PSCRATCH_BUFFER_STRUCT, BYTE *, int, int, int, RGBQUAD *);
typedef BOOL (_PVPAPI PFN_GETRGBQUAD)(HGDC, GRAPH_COLOR, RGBQUAD *);
#endif
...
typedef VPSTATUS (_PVPAPI PFNBITMAP_CREATEFROMGIF) (PFNSOURCEFILLBUFFER,PVOID,PGRAPH_BITMAPINFO,PBYTE*, PUINT32);
typedef VPSTATUS (_PVPAPI PFNBITMAP_QUERYGIFINFORMATION) (PFNSOURCEFILLBUFFER,PVOID,PGRAPH_BITMAPINFO,PUINT32);
...
typedef VPSTATUS (_PVPAPI PFNBITMAP_CREATEFROMENCODEDH264)(PBITMAP_ENCODED_DATA, PBITMAP_DECODER_CALLBACK,PBITMAP_DECODE_DATA,PGRAPH_RECT);
typedef VPSTATUS (_PVPAPI PFNBITMAP_QUERYENCODEDINFORMATIONH264)(PBITMAP_ENCODED_DATA, PUINT,PUINT32,PGRAPH_RECT);
...
typedef struct _GRAPHCALLTABLE
{
    ...
    PFNBITMAP_CREATEFROMGIF     pfnBitmap_createFromGIF;
    PFNBITMAP_QUERYGIFINFORMATION pfnBitmap_queryGIFInformation;
    ...
    PFNBITMAP_CREATEFROMENCODEDH264         pfnBitmap_createFromEncodedH264;
    PFNBITMAP_QUERYENCODEDINFORMATIONH264   pfnBitmap_queryEncodedInformationH264;
...
#define Bitmap_createFromGIF (*(g_pGraphCallTable)->pfnBitmap_createFromGIF)
#define Bitmap_queryGIFInformation (*(g_pGraphCallTable)->pfnBitmap_queryGIFInformation)
...
#define Bitmap_createFromEncodedH264 (*(g_pGraphCallTable)->pfnBitmap_createFromEncodedH264)
#define Bitmap_queryEncodedInformationH264 (*(g_pGraphCallTable)->pfnBitmap_queryEncodedInformationH264)
...
VPSTATUS _VPAPI Bitmap_createFromEncodedH264(PBITMAP_ENCODED_DATA pEncodedData, PBITMAP_DECODER_CALLBACK pRenderCallback, PBITMAP_DECODE_DATA pDecodedData,PGRAPH_RECT rect);

VPSTATUS _VPAPI Bitmap_queryEncodedInformationH264(PBITMAP_ENCODED_DATA pEncodedData, PUINT pDesiredBitsPerPixel, PUINT32 pDecompressedByteCount,PGRAPH_RECT rect);
